$(document).ready(function () {
	...
	var chall = [
		...
		},
		{
			...
			text: 'DURANT LES 2 SEMAINES DE GAVAGE, LES CANARDS SONT DÉTENUS DANS DES CAGES COLLECTIVES.',
			style: {
				mobile: {
					titre: {'font-size': '18px', 'top': '-35px'},
		...
		{
			titre: 'CANETONS FEMELLES',
			text: 'JUGÉES MOINS RENTABLES QUE LES MÂLES, 35 MILLIONS DE CANETONS FEMELLES SONT BROYÉES QUELQUES HEURES APRÈS LEUR NAISSANCE CHAQUE ANNÉE.',
			style: {
				mobile: {
		...
		},
		{
			...
			text: 'EN PÉRIODE DE GAVAGE, LES PROBLÈMES DIGESTIFS ET RESPIRATOIRES SONT ANORMALEMENT NOMBREUX. LE TAUX DE MORTALITÉ DES CANARDS GAVÉS EST 10 À 20 FOIS SUPÉRIEUR.',
			style: {
				mobile: {
		...
		},
		{
			...
			text: 'EN 2 À 3 SECONDES, LES CANARDS REÇOIVENT D’IMPORTANTES QUANTITÉS DE NOURRITURE DÉVERSÉE DIRECTEMENT DANS LE JABOT.',
			style: {
				mobile: {
					titre: {'font-size': '18px', 'top': '-35px'},
					text: {'font-size': '12px', 'top': '10px'}
		...
		},
		{
			...
			text: 'EN FIN DE PÉRIODE DE GAVAGE, LES CANARDS SONT FORCÉS D’INGURGITER JUSQU’À 900 G DE NOURRITURE PAR JOUR, CONTRE 300 G ENVIRON DEUX SEMAINES PLUS TÔT.',
			style: {
				mobile: {
					titre: {'font-size': '18px', 'top': '-35px'},
					text: {'font-size': '12px', 'top': '10px'}
