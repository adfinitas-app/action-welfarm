$(document).ready(function () {
	...
	var chall = [
		...
		},
		{
			...
			text: 'EN PÉRIODE DE GAVAGE, LES PROBLÈMES DIGESTIFS ET RESPIRATOIRES SONT ANORMALEMENT NOMBREUX. LE TAUX DE MORTALITÉ DES CANARDS GAVES EST 10 À 20 FOIS SUPÉRIEUR.',
			style: {
				mobile: {
