$(document).ready(function () {
	...
	var chall = [
		...
		},
		{
			...
			text: 'EN PÉRIODE DE GAVAGE, LES PROBLÈMES DIGESTIFS ET RESPIRATOIRES SONT ANORMALEMENT NOMBREUX. LE TAUX DE MORTALITÉ DES CANARDS GAVES EST 10 À 20 FOIS SUPÉRIEUR A CEUX ELEVES POUR LEUR VIANDE.',
			style: {
				mobile: {
		...
		},
		{
			...
			text: 'EN FIN DE PÉRIODE DE GAVAGE,LES CANARDS INGURGITENT DE FORCE JUSQU’À 900 G DE NOURRITURE PAR JOUR, CONTRE 300 G ENVIRON DEUX SEMAINES PLUS TÔT.',
			style: {
				mobile: {
					titre: {'font-size': '18px', 'top': '-35px'},
					text: {'font-size': '12px', 'top': '10px'}
